...
To save vm state we need to store @names@, @lens@, @types@ values and dump @addrs@ memory areas.

For forth and data words we exclude first five bytes (interpreter call instructions). For machine code words everything is stored.
